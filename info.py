...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>ꜰɪʟᴇ ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ [𝙲𝚒𝚗𝚎𝚖𝚊𝚅𝚎𝚗𝚘𝙾𝚏𝚏𝚒𝚌𝚒𝚊𝚕™](https://t.me/CinemaVenoOfficial)</b>⚡\n•────•────────•────•\n🎦 <b>ꜰɪʟᴇ ɴᴀᴍᴇ: </b> ➥  <i>{file_caption}</i>\n\n⚙️ <b>ꜱɪᴢᴇ: </b><i>{file_size}</i>\n\n        ❤️<b>🅆🄴 🄻🄾🅅🄴 🅈🄾🅄</b>❤️\n\n               <b>Ⓙⓞⓘⓝ Ⓝⓞⓦ\n   [⏳𝙲𝚒𝚗𝚎𝚖𝚊𝚅𝚎𝚗𝚘𝙾𝚏𝚏𝚒𝚌𝚒𝚊𝚕™⏳](https://t.me/CinemaVenoOfficial)</b>•────•────────•────•\n🎗 ʝσιи • ѕнαяє • ѕυρρσят 🎗")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>ʏᴏᴜʀ Qᴜᴇʀʏ: {query}</b> \n‌ɪᴍᴅʙ ᴅᴀᴛᴀ ʙʏ: @CinemaVenoOfficial \n\n🏷 ᴛɪᴛʟᴇ: <a href={url}>{title}</a>\n🎭 ɢᴇɴʀᴇꜱ: {genres}\n📆 ʏᴇᴀʀ: <a href={url}/releaseinfo>{year}</a>\n🌟 ʀᴀᴛɪɴɢ: <a href={url}/ratings>{rating}</a> / 10 \n\n🌟 ʏᴏᴜʀ ꜱᴜᴘᴘᴏʀᴛ ᴍᴇᴀɴꜱ ᴛʜᴇ ᴡᴏʀʟᴅ ᴛᴏ ᴜꜱ 🌟 \n\n💛 ᴘʟᴇᴀꜱᴇ ꜱʜᴀʀᴇ ᴜꜱ 💛\n\n🦋ꜰᴏʀ ᴀ ᴘʀɪᴠᴀᴛᴇ ᴄɪɴᴇᴍᴀᴛɪᴄ ᴇxᴘᴇʀɪᴇɴᴄᴇ, ᴛᴀᴘ ʙᴇʟᴏᴡ!🦋")
